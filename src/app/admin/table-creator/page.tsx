...
export default function AdminExportPage() {
  ...
  const filteredAttendees = useMemo(() => {
    return attendees.filter((attendee) => {
      ...
      return matchesSearch && matchesAdmission && matchesCountry && matchesPosition
    })
  }, [attendees, searchTerm, selectedAdmissions, selectedCountries, selectedPositions])
      ...
      <div className="max-w-[90rem] mx-auto space-y-8">
        ...
        <div className="bg-white p-6 md:p-8 rounded-2xl shadow-md border-2 border-brand-burgundy">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6 items-end">
            ...
            <div className="lg:col-span-1">
              <label className="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-wider">Search Name</label>
              <input
                type="text"
                value={searchTerm}
        ...
        <div className="bg-white rounded-xl shadow border border-gray-300 overflow-hidden">
          ...
          <div className="bg-gray-50 border-b border-gray-300 px-4 py-3 flex flex-col md:flex-row md:items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2 md:pl-4 md:border-l border-gray-300 self-start md:self-auto">
              ...
              <table className="w-full text-left border-collapse whitespace-nowrap table-auto">
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {sortedAttendees.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan={selectedColumns.length} className="px-4 py-12 text-center text-gray-500">
